function SubscribeSection() {
    return (
      <div className='d-flex flex-column libre-baskerville-regular align-items-center'>
        <p className='fw-semibold'><small>Join the Tailormark Style Community</small></p>
        <p className='fw-bold fs-4'>Subscribe now & get 20% off</p>
        <p>Tailormark Fashion – Where Style Meets Confidence.</p>
